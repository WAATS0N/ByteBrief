    ...
    return (
        <div className="min-h-screen bg-black overflow-hidden selection:bg-purple-500/30">
            ...
            <div className="fixed inset-0 z-0">
                <div className="absolute top-0 -left-1/4 w-full h-full bg-gradient-to-br from-purple-900/20 via-black to-black rounded-full blur-[120px]" />
                <div className="absolute bottom-0 -right-1/4 w-full h-full bg-gradient-to-tl from-cyan-900/20 via-black to-black rounded-full blur-[120px]" />
            ...
            <div className="relative z-10">
                ...
                <header className="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <Link to="/login" className="bg-white text-black px-5 py-2 rounded-full font-semibold hover:bg-gray-200 transition-colors">
                            Sign up
                        </Link>
                    </div>
                </header>
                ...
                {/* Hero Content */}
                <main className="pt-20 pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
